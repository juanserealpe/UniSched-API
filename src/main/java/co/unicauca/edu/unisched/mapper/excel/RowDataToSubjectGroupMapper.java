...
/**
 * Maps an {@link RowData} into a {@link SubjectGroup} domain entity.
 *
 ...
 */
@Component
public class RowDataToSubjectGroupMapper implements IExcelRowMapperPort<SubjectGroup> {
     ...
     */
    public SubjectGroup map(RowData row, Long academicYear, byte academicSemester) {
    ...
    @Override
    public SubjectGroup map(RowData row) {
     ...
     */
    private void parseAndAddSchedule(RowData row, String columnName,
     ...
     */
    private Long parseLong(String value, RowData row) {
        try {
